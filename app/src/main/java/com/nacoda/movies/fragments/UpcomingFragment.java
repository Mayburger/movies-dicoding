...
public class UpcomingFragment extends BaseFragment implements LoaderManager.LoaderCallbacks<ArrayList<Movie>> {
    ...
    public Loader<ArrayList<Movie>> onCreateLoader(int id, final Bundle loaderArgs) {
        return new UpcomingLoader(getActivity(), progressBar);
    }
