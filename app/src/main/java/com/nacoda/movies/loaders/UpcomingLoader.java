...
public class UpcomingLoader extends AsyncTaskLoader<ArrayList<Movie>> {
    ...
    public UpcomingLoader(@NonNull Context context, ProgressWheel progressBar) {
        super(context);
    ...
    public ArrayList<Movie> loadInBackground() {
        ...
        String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=" + API_KEY + "&language=" + getContext().getString(R.string.api_language);
