...
public class ImagesBannerWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.nacoda.stackwidget.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.nacoda.stackwidget.EXTRA_ITEM";
    public static final String MOVIE_NAME = "com.nacoda.stackwidget.MOVIE_NAME";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(TOAST_ACTION)) {
            ...
            String mMovieName = intent.getStringExtra(MOVIE_NAME);

            Toast.makeText(context, mMovieName, Toast.LENGTH_SHORT).show();
